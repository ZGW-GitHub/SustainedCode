...
@MapperScan(basePackages = "com.code.jta.dal.first.mapper", sqlSessionFactoryRef = "firstSqlSessionFactory")
public class FirstMybatisConfiguration {
	...
	public DataSource firstDataSource(MultipleDataSourceProperties properties) {
		...
		atomikosDataSourceBean.setUniqueResourceName("firstResource");
