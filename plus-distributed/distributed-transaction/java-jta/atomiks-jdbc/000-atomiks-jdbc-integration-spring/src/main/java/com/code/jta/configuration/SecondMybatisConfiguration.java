...
@MapperScan(basePackages = "com.code.jta.dal.second.mapper", sqlSessionFactoryRef = "secondSqlSessionFactory")
public class SecondMybatisConfiguration {

	@Bean
	public DataSource secondDataSource(MultipleDataSourceProperties properties) {
		XADataSource xaDataSource = DataSourceBuilder.create()
		...
		atomikosDataSourceBean.setUniqueResourceName("secondResource");
