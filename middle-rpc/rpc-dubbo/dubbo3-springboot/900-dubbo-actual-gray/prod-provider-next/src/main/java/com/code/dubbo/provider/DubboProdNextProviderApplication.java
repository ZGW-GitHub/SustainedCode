...
public class DubboProdNextProviderApplication {
	public static void main(String[] args) {
		...
		new SpringApplicationBuilder(DubboProdNextProviderApplication.class).run(args);
		log.info("DubboProdNextProviderApplication 启动成功");
