...
package com.code.spring.authorization.mode.code.server.configuration;

import cn.hutool.core.util.IdUtil;
import com.code.spring.authorization.mode.code.server.config.AuthorizationServerConfig;
import com.code.spring.authorization.mode.code.server.config.KeystoreConfig;
...
public class SpringAuthorizationServerConfiguration {
	...
	private RegisteredClient createRegisteredClientAuthorizationCode(final String clientId) {
		...
		// http://notuptoyou.com:65000/oauth2/authorize?client_id=demo_client&response_type=code&scope=read%20write&redirect_uri=http://127.0.0.1:65001/login/oauth2/code/demo_client
