...
package com.code.spring.security.component.security;
...
public class CustomAuthenticationProvider extends DaoAuthenticationProvider {
	...
	private static UsernamePasswordAuthenticationToken encodeAuthenticationRequestPassword(String presentedPassword, UserDetails user, String username) {
		...
		return UsernamePasswordAuthenticationToken.unauthenticated(username, PasswordUtil.encode(presentedPassword, sysUser.getSalt()));
	}
