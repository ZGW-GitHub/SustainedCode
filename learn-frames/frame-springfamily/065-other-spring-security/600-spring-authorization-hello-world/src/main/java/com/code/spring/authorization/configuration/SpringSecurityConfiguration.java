...
public class SpringSecurityConfiguration {
	...
	public RegisteredClientRepository registeredClientRepository() {
		// http://127.0.0.1:65000/oauth2/authorize?client_id=demo-client&response_type=code&scope=demo.read&redirect_uri=https://www.bing.com
	...
	public JWKSource<SecurityContext> jwkSource() {
		...
		RSAKey rsaKey = new RSAKey.Builder(publicKey).privateKey(privateKey).keyID(IdUtil.randomUUID()).build();
