...
package com.code.mq.kafka.producer.interceptor;

import com.code.mq.kafka.KafkaApplicationTest;
import com.code.mq.kafka.producer.interceptor.component.CustomInterceptor;
...
public class ProducerTest extends KafkaApplicationTest {
	...
	public static final String TARGET_TOPIC = "SEND_WAY_SYNC";
	...
	private KafkaProducer<String, String> makeClient() {
		...
		// properties.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, CustomInterceptor.class.getName()); // 可以配置多个拦截器
