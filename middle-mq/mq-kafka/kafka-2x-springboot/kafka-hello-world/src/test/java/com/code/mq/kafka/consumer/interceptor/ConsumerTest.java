...
package com.code.mq.kafka.consumer.interceptor;

import com.code.mq.kafka.KafkaApplicationTest;
import com.code.mq.kafka.consumer.interceptor.component.CustomInterceptor;
...
public class ConsumerTest extends KafkaApplicationTest {
	...
	private KafkaConsumer<String, String> makeClient() {
		...
		// 配置拦截器
		properties.put(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG, CustomInterceptor.class.getName());
		// properties.put(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG, CustomInterceptor.class.getName()); // 可以配置多个拦截器
