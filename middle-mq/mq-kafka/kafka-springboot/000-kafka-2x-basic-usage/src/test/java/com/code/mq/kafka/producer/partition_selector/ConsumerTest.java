...
public class ConsumerTest extends KafkaApplicationTest {
	...
	void consumerTest() throws InterruptedException {
		...
		// 订阅主题
		consumer.subscribe(Collections.singletonList(ProducerByDefaultPartitionerTest.TARGET_TOPIC));
	...
	private KafkaConsumer<String, String> makeClient() {
		...
		properties.put(ConsumerConfig.CLIENT_ID_CONFIG, ProducerByDefaultPartitionerTest.TARGET_TOPIC + "-consumer");
