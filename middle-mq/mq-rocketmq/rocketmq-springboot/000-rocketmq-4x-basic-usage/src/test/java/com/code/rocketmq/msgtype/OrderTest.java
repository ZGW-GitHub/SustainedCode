 ...
 */
@Slf4j
public class OrderTest extends RocketMqApplicationTest {
	...
	public void simpleTest() {
		...
		// 发送消息
		SendResult sendResult = producer.send(msg, new SelectMessageQueueByHash(), msg.getProperties().getOrDefault("selectObj", "xxx"));
	...
	public void consumerTest() {
		...
		PushConsumerUtil.startConsumer(consumer, PushConsumerUtil::order);
	}
