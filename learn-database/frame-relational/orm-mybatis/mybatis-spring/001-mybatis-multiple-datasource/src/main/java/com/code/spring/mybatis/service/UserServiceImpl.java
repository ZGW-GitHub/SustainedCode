...
package com.code.spring.mybatis.service;

import com.code.spring.mybatis.dal.first.dos.FirstUser;
import com.code.spring.mybatis.dal.first.mapper.FirstUserMapper;
import com.code.spring.mybatis.dal.second.dos.SecondUser;
import com.code.spring.mybatis.dal.second.mapper.SecondUserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public void demo() {
        ...
        secondUserMapper.save(new SecondUser().setName("test").setAge(16));
    }
