...
package com.code.sharding.spring.coding.configuration;
...
@MapperScan(basePackages = "com.code.sharding.spring.coding.dal.second.mapper", sqlSessionFactoryRef = "secondSqlSessionFactory")
